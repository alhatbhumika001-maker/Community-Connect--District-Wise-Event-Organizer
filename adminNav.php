    ...
    <div class="sidebar d-none d-md-block">
        ...
        <a href="adminProfile.php" class="<?php if ($active == 'adminProfile') echo 'active'; ?>"><i
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileSidebar">
        ...
        <div class="offcanvas-body p-0 bg-dark">
            <nav class="nav flex-column p-3">
                ...
                <a class="nav-link text-white <?php if ($active == 'events') echo 'fw-bold'; ?>"
                    href="eventInsights.php"><i class="bi bi-calendar-event me-2"></i>Manage Events</a>
