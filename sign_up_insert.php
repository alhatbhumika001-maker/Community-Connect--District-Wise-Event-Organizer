...
// Insert Query
$q = "INSERT INTO users (user_id, full_name, username, email, password, confirm_password, role, district,bio)
      VALUES (NULL, '$full_name', '$username', '$email', '$password', '$confirm_password', '$role', '$district','$bio')";
